...
import BuyersProfileChart from './EmployeesProfileChart';
import { PieDataItemOption } from 'echarts/types/src/chart/pie/PieSeries.js';

const EmployeesProfile = (): ReactElement => {
  const theme = useTheme();
  const seriesData: PieDataItemOption[] = [
    { value: 50, name: 'Hombres' },
    { value: 35, name: 'Mujeres' },
    { value: 15, name: 'Otros' },
  ];
  const legendData = [
    { name: 'Hombres', icon: 'circle' },
    { name: 'Mujeres', icon: 'circle' },
    { name: 'Otros', icon: 'circle' },
  ];
  ...
  return (
    <Stack
      sx={{
        ...
        height: 1,
        flex: '1 1 auto',
        width: { xs: '50%', sm: 0.5, lg: '50%', md: '50%' },
